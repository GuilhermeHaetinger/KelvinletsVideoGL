...
DEPENDECIES=$(MAIN_OBJECT) $(LOGGER_OBJECT) $(LINE_OBJECT) $(POINT_OBJECT) $(RENDERABLE_FRAME_OBJECT) $(VIDEO_GL_OBJECT) $(VIDEO_WINDOW_OBJECT) $(SHADER_COMPILER_OBJECT) $(PROPORTIONS_OBJECT) 

$(KELVIN): $(DEPENDECIES)
	$(CC) -o $(KELVIN) $(MAIN_OBJECT) $(LOGGER_OBJECT) $(LINE_OBJECT) $(POINT_OBJECT) $(RENDERABLE_FRAME_OBJECT) $(VIDEO_GL_OBJECT) $(VIDEO_WINDOW_OBJECT) $(SHADER_COMPILER_OBJECT) $(PROPORTIONS_OBJECT) $(FLAGS)
